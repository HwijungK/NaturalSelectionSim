...
A creature has a set size and speed. When a creature is a certain amount larger than another creature, a collision between the two creatures will result in the larger creature consuming the smaller creature. The size and speed of a creature is balanced by how quickly it uses up energy.
...
If a creature is energy positive, it has a positive $\Delta E$. If a creature is energy negative, it must eat other creatures to gain energy. By eating, a creature gains the energy of the other creature, and additional energy proportional to the consumed creature's size.
